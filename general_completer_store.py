...
from ycmd.completers.general.vsnip_completer import VSnipCompleter
...
class GeneralCompleterStore( Completer ):
  ...
  def __init__( self, user_options ):
    ...
    self._vsnip_completer = VSnipCompleter( user_options )
    self._non_filename_completers = [ self._identifier_completer, self._vsnip_completer ]
